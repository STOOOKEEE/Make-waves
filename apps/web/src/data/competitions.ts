...
const COMPETITIONS_RAW: RawCompetition[] = [
  {
    ...
    long: {
      en: "The Grand Championship is TIDE's marquee season. For six weeks, every trader starts with the same virtual capital and a single goal: the highest net return. No entry fee, no KYC — just your read of the market against 12,480 rivals. The top 50 share the pot, paid on-chain at the close.",
      fr: "Le Grand Championnat est la saison reine de TIDE. Pendant six semaines, chaque trader part avec le même capital virtuel et un seul objectif : le plus haut rendement net. Pas de frais d'entrée, pas de KYC, juste ta lecture du marché contre celle de 12 480 concurrents. Les 50 meilleurs se partagent la cagnotte, versée on-chain à la clôture.",
    },
    pot: "$50,000",
    fee: { en: "Free", fr: "Gratuit" },
    players: { en: "12,480", fr: "12 480" },
    cap: "",
    pct: 0,
    daysLeft: 4,
